...
|-------|-----------|-----------|
| **1** | Select all images of a target object (e.g. fire hydrant, donut, traffic light) | 7–8 “correct” tiles, 1–2 obvious decoys; Pexels (large) and/or LoremFlickr (server) |
